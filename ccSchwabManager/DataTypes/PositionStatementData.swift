...
//            print( "!!! reconstitutedRow: \(reconstitutedRow)" )
...
//            else
//            {
//                print( "Skipping \(values.count) (vs \(PositionStatementColumns.allCases.count) ) element row: \(row)" )
//                print( "Elements: " )
//                var n : Int = 0
//                row.split(separator: ",").forEach { print( "\(n): \($0)" ); n += 1 }
//                if( "ABT" == row.split(separator: ",").first )
//                {
//                    break
//                }
//            }
